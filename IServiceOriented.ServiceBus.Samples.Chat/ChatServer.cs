...
namespace IServiceOriented.ServiceBus.Samples.Chat
{
    public class ChatServer
    {
        ...
        {            
            ...
            _serviceBus.Subscribe(new SubscriptionEndpoint(Guid.NewGuid(), "Chat Service Transformer", null, null, typeof(IChatService2), new ChatServiceTransformer(), new TypedMessageFilter(typeof(SendMessageRequest))));
